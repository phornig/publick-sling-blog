...
module.exports = (function (app) {
  ...
  app.engine('hbs', hbs());
  app.set('views', path.join(rootPath, '../src/main/resources/jcr_root/libs/'));
  ...
  app.use(express['static'](path.join(rootPath, '../src/main/resources/jcr_root/')));
  ...
  app.get('*', function (req, res) {
    var model = resolver.getJson(path.join('pages', req.path));
